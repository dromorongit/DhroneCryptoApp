...
const ErrorState = ({ title = 'Something went wrong', message, onRetry }: ErrorStateProps) => {
  return (
    <div className="text-center py-16 px-4">
      <div className="w-20 h-20 bg-gradient-to-br from-red-500/10 to-rose-500/10 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-red-500/5">
